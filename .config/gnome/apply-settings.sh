...
configure_dock() {
    ...
    set_setting org.gnome.shell favorite-apps \
        "['org.gnome.Nautilus.desktop', 'librewolf.desktop', 'bitwarden.desktop', 'org.mozilla.Thunderbird.desktop', 'org.telegram.desktop.desktop', 'vscodium.desktop', 'kitty.desktop', 'com.shellyorg.shelly.desktop', 'steam.desktop', 'onlyoffice-desktopeditors.desktop', 'org.gnome.SystemMonitor.desktop']"
}
